...
plt.xlabel('Time [h] ')
plt.suptitle('Load shifting in Time of Use pricing scheme',fontsize=16)
plt.show()
...
plt.ylabel('Temperature [\u00B0C]')
plt.xlabel('Time [h] ')
plt.suptitle('Load shifting in Real time pricing scheme',fontsize=16)
plt.show()
...
color = 'tab:blue'
ax2.set_ylabel('Time of use price [cent/kWh]', color=color)  # we already handled the x-label with ax1
...
color = 'tab:blue'
ax4.set_ylabel(' Real time price [cent/kWh]', color=color)  # we already handled the x-label with ax1
